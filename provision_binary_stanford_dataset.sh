...
cd $DATA_DIR
/b2-linux file download b2://calcium-dataset/stanford-aimi-archivestanford_binary_partial_occ.zip stanford_binary_partial_occ.zip

unzip stanford_binary_partial_occ.zip
